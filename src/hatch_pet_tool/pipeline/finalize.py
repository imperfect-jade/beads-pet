...
def main() -> None:
    ...
    run(
        [
            sys.executable,
            "-m",
            "hatch_pet_tool.image.contact_sheet",
            str(final_dir / "spritesheet.webp"),
            "--output",
    ...
    if not args.skip_package:
        package_command = [
            sys.executable,
            "-m",
            "hatch_pet_tool.pipeline.package_codex",
            "--pet-name",
            pet_id,
            "--display-name",
            display_name,
